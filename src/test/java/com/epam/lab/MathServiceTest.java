...
import com.epam.lab.service.MathService;
import com.epam.lab.service.SimpleMathService;
...
class MathServiceTest {
    ...
    @ParameterizedTest
    @MethodSource("com.epam.lab.Providers#testCompare")
    ...
    @ParameterizedTest
    @MethodSource("com.epam.lab.Providers#testSumProvider")
    ...
    @ParameterizedTest
    @MethodSource("com.epam.lab.Providers#testGetEvenDigitsProvider")
    ...
    @ParameterizedTest
    @MethodSource("com.epam.lab.Providers#testCalcFactorialProvider")
    ...
    @ParameterizedTest
    @MethodSource("com.epam.lab.Providers#testCalcFibonacciProvider")
    ...
    @ParameterizedTest
    @MethodSource("com.epam.lab.Providers#testSortProvider")
    ...
    @ParameterizedTest
    @MethodSource("com.epam.lab.Providers#testIsPrimaryProvider")
    ...
    @ParameterizedTest
    @MethodSource("com.epam.lab.Providers#testReverseArrayProvider")
